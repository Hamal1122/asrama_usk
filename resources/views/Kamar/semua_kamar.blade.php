  ...
  <div class="bg-gray-soft flex flex-wrap p-4 mt-4 font-light text-sm text-gray-dark gap-4 container mx-auto">
    ...
    <div class=" bg-white p-4 rounded-md">
      ...
      <div class="mt-2">
        ...
        <h3 class="bg-blue bg-opacity-10 text-purple py-1 px-2 rounded-lg w-fit mt-2">{{ $kamar->gedung->kategori_gedung }}</h3>
        <h3 class="mt-2 bg-green bg-opacity-10 text-green py-1 px-2 rounded-lg w-fit"><span class="text-abu">2 / </span>{{ $kamar->kapasitas }} Orang</h3>
      </div>

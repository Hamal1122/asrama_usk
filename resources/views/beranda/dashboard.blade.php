    ...
    <div class="bg-white overflow-hidden transition-all duration-500 max-h-0 peer-checked:max-h-[1000px] rounded-md mt-1 text-gray-dark">
      <div class="p-4 py-8">
        ...
        <div class="flex gap-8 items-center px-6">
          <div>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-1-square-fill " viewBox="0 0 16 16">
          ...
          <div>
            <p class="font-light text-sm bg-gray-dark bg-opacity-5 px-2 py-2 rounded-lg">Anda wajib melengkapi berkas yang dibutuhkan untuk pengajuan kamar di menu <a class="text-blue" href="{{route ('berkas') }}">Pengajuan Berkas</a> .</p>
          </div>
        </div>

        <div class="flex gap-8 items-center px-6 mt-8">
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-2-square-fill" viewBox="0 0 16 16">
          ...
          <div>
            <p class="font-light text-sm bg-gray-dark bg-opacity-5 px-2 py-2 rounded-lg">Anda wajib melengkapi form pengajuan kamar untuk mengajukan kamar ke pihak Asrama USK . </p>
          </div>
        </div>

        <div class="flex gap-8 items-center px-6 mt-8">
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-3-square-fill" viewBox="0 0 16 16">
          ...
          <div>
            <p class="font-light text-sm bg-gray-dark bg-opacity-5 px-2 py-2 rounded-lg">Setelah data anda berhasil di Upload , Pihak Asrama USK mengecek dan memvalidasi bahwa data yang anda upload lengkap dan sesuai.</p>
          </div>
        </div>

        <div class="flex gap-8 items-center px-6 mt-8">
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-4-square-fill" viewBox="0 0 16 16">
        ...
        <div class="flex gap-8 items-center px-6 mt-8">
          <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="bi bi-5-square-fill" viewBox="0 0 16 16">

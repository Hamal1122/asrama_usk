...
<div class="col-span-12 lg:col-span-10 w-full px-4">
    ...
    <div class="flex flex-wrap mt-4 gap-8 bg-white rounded-md px-6 py-8">
        <div
            class="bg-white font-poppins text-gray-dark py-4 px-8 rounded-2xl text-center flex gap-8 items-center drop-shadow-md w-60"
        >
            <div class="text-left">
                ...
                <h1 class="text-yellow text-xs font-extralight">
                    Total Gedung
                </h1>
            </div>
        </div>

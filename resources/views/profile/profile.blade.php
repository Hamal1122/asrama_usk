    ...
    <div class="p-4 bg-white flex gap-4 flex flex-wrap justify-between">
      ...
      <div class="my-auto flex flex-wrap text-gray-dark font-Inter mx-auto md:mx-4">
        ...
        <div class="mx-auto md:mx-4">
          <h3 class="my-2">Nama : <span class="font-bold"></span></h3>
          <h3 class="my-2">NIM : <span class="font-bold"></span></h3>
          <h3 class="my-2">No.Telpon : <span class="font-bold"></span></h3>
          <h3 class="my-2">Program Studi : Informatika</h3>
          <h3 class="my-2">Email : <span class="font-bold"></span></h3>
          <h3 class="my-2">Gender : <span class="font-bold"></span></h3>
        </div>

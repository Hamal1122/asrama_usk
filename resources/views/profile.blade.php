    ...
    <section>
      ...
      <div class="container mx-auto ">
        <div class="grid grid-cols-12">
          ...
          <div class="col-span-3 hidden sm:block">
            <nav class="bg-white h-screen w-3/4 text-center shadow-md px-4 rounded-md ">
              ...
              <li class="transition-all my-6 text-left p-4 cursor-pointer rounded-lg text-base font-Inter  text-gray-dark hover:bg-bermuda hover:text-blue"><a href="{{route ('beranda') }}">Beranda</a></li>
                <li class="transition-all my-6 text-left p-4 cursor-pointer rounded-lg text-base font-Inter bg-blue text-white "><a href="{{route ('profile') }}">Profil</a></li>
          ...
          <div class="flex flex-wrap  bg-white px-6 py-4 gap-6 rounded-md">
            <div class="my-auto mx-6 w-24">
            <img src=".../public/asset/person.png" alt="">
            </div>
            <div class="order-2 font-poppins">
              <p>Nama : Hamal</p>
              <p>NPM : 2008107010045</p>
              <p>Telepon : 085226778940</p>
              <p>Agama : Islam</p>
              <p>Jenis kelamin : Laki-laki</p>
              <p>Alamat : Tijue</p>
              <p>Tgl. Lahir :11 November 2001 </p>
            </div>
